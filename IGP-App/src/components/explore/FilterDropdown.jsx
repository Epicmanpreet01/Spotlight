...
/*
 Props:
  ...
  - onClose: () => void
  - onApply: (filter) => void
    - budget: { type: 'budget', min: number, max: number }
    - date: { type: 'date', value: 'week' | 'month' }
*/
    ...
    <View style={styles.overlay}>
      ...
      <View style={[styles.container, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}>
        ...
        >
          ...
          <Ionicons name={expanded === 'budget' ? 'chevron-up' : 'chevron-down'} size={18} color={theme.colors.textSecondary} />
        </TouchableOpacity>
        ...
        {expanded === 'budget' && (
          <View style={styles.expanded}>
            ...
            <Text style={[styles.subTitle, { color: theme.colors.text, marginTop: 10 }]}>Custom range</Text>
            ...
            <TouchableOpacity style={[styles.applyBtn, { backgroundColor: theme.colors.primary }]} onPress={applyCustomBudget}>
        ...
        >
          <View style={styles.left}>
            ...
            <Text style={[styles.rowText, { color: theme.colors.text }]}>Event Date</Text>
          </View>
          <Ionicons name={expanded === 'date' ? 'chevron-up' : 'chevron-down'} size={18} color={theme.colors.textSecondary} />
        </TouchableOpacity>

        {/* Date expanded */}
        {expanded === 'date' && (
          <View style={styles.expanded}>
            <Text style={[styles.subTitle, { color: theme.colors.text }]}>Quick pick</Text>
            <View style={{ flexDirection: 'row', gap: 10, marginTop: 8 }}>
              <TouchableOpacity
                style={[styles.presetBtn, { borderColor: theme.colors.border }]}
                onPress={() => applyDate('week')}
              >
                <Text style={{ fontWeight: '700', color: theme.colors.text }}>This Week</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[styles.presetBtn, { borderColor: theme.colors.border }]}
                onPress={() => applyDate('month')}
              >
                <Text style={{ fontWeight: '700', color: theme.colors.text }}>This Month</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
